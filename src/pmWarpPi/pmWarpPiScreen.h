...
public:
    ...
    void        setup(bool hasVideo, bool hasImage, bool _useFbo, bool _useHomograhy, bool texureMode, bool hasAudio, bool loop, string initVideoFile = " ", string initImageFile = " ");
    void        update();
